 ...
 * @date 2020-01-04
 */
export default class CLPSO {
    // 构造函数
    constructor(dimension, ub, lb, fitFunc, particleNum, maxStep) {
        // 粒子个数
        this.particleNum = particleNum || 30;
        // 单个粒子的维度
...
class Particle {
    ...
    update(w, stepPbest) {
        ...
        if (fitnessObject < this.pbestValue) {
            this.pbest = this.position;
            this.pbestValue = fitnessObject;
        }
    };
